...
#TRACK-CHANGE 06/29/2019 put full paths to imports
...
class MLPClassifier_jkjMod(BaseMultilayerPerceptron, ClassifierMixin):
    ...
    Notes
    -----
    MLPClassifier_jkjMod trains iteratively since at each time step
    ...
    def __init__(self, hidden_layer_sizes=(100,), activation="relu",
        ...
        #TRACK-CHANGE 06/29/2019 added a print statement
        print('this modified version of sklearn MLP classifier uses mutual information')
